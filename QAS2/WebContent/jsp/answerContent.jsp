...
%>
	<form method=POST action="<%=request.getContextPath() %>/ModificationServlet" id="modify" target="right">
		...
		<center><input type="button" value="提交修改" onclick="submit()"></center>
	</form>
</body>
</html>